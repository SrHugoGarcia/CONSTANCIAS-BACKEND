...
const userSchema = new mongoose.Schema({
    nombre: {
        ...
        maxlength: [50,"Un nombre debe de tener como maximo 50 caracteres"],
        trim: true,        
    },
    apellidoPaterno: {
        type: String,
        ...
        maxlength: [50, "Un apellido paterno debe de tener como maximo 30 caracteres"],
        trim: true,
    },
    apellidoMaterno: {
        type: String,
        ...
        maxlength: [50,"Un apellido materno debe de tener como maximo 50 caracteres"],
        trim: true,
    },
    correo: {
        type: String,
